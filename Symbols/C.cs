...
namespace SchemeVisualisation
{
    ...
    {
        public C(Entity Src, List<PortS> P)
            : base(Src, P)
        {
        ...
        public override void DrawMe(Graphics e, int kx, int ky, float x0, float y0) //Масштаб + начальные коо
        {
            ...
            e.DrawString("C", Setting.Global.Font, Setting.Global.Brush, Setting.Global.Rec, Setting.Global.Format); //Зашибись, сама центрует
        }
